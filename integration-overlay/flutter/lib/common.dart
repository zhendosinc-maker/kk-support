...
class MyTheme {
  ...
  static const Color grayBg = Color(0xFFF3F1EE);
  static const Color accent = Color(0xFFE07B00);
  static const Color accent50 = Color(0x77E07B00);
  static const Color accent80 = Color(0xAAE07B00);
  static const Color canvasColor = Color(0xFF1A1714);
  static const Color border = Color(0xFFCCCCCC);
  static const Color idColor = Color(0xFFE07B00);
  static const Color darkGray = Color.fromARGB(255, 148, 148, 148);
  static const Color cmIdColor = Color(0xFF21790B);
  static const Color dark = Colors.black87;
  static const Color button = Color(0xFFF0A020);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        ...
        foregroundColor: Color(0xFF161412),
        shape: RoundedRectangleBorder(
          borderRadius: BorderRadius.circular(8.0),
        ),
      ),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    hoverColor: Color.fromARGB(255, 62, 44, 24),
    scaffoldBackgroundColor: Color(0xFF161412),
    dialogBackgroundColor: Color(0xFF161412),
    appBarTheme: AppBarTheme(
      shadowColor: Colors.transparent,
    ),
    dialogTheme: DialogTheme(
    ...
    outlinedButtonTheme: OutlinedButtonThemeData(
      style: OutlinedButton.styleFrom(
        backgroundColor: Color(0xFF2A1C0A),
    ...
    menuBarTheme: MenuBarThemeData(
        style: MenuStyle(
            backgroundColor: MaterialStatePropertyAll(Color(0xFF121110)))),
...
String getWindowName({WindowType? overrideType}) {
  ...
  switch (overrideType ?? kWindowType) {
    case WindowType.Main:
      return isWindows ? 'Крошка Картошка — Техническая поддержка' : name;
